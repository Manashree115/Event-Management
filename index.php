...
<body class="bg-light">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-12 text-center mt-5">
        <a href="rooms.php" class="btn btn-sm btn-outline-dark rounded-0 fw-bold shadow-none">More Venues >>></a>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row justify-content-evenly px-lg-0 px-md-0 px-5">
      ...
      <div class="col-lg-12 text-center mt-5">
        <a href="facilities.php" class="btn btn-sm btn-outline-dark rounded-0 fw-bold shadow-none">More SERVICES >>></a>
      </div>
    </div>
  </div>
